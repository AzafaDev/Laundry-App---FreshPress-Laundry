...
const navItems = [
  ...
  { icon: ClipboardList, label: "Station", href: "/dashboard/worker/station" },
  { icon: Package, label: "Packing", href: "/dashboard/worker/packing" },
  { icon: Clock, label: "Attendance", href: "/dashboard/worker/attendance" },
  { icon: BarChart3, label: "History", href: "/dashboard/worker/history" },
];

export const WorkerSidebar = ({ activePath = "" }: WorkerSidebarProps) => {
