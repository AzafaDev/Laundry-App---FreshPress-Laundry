...
import { User, Mail, Phone, ArrowRight, Shirt, CheckCircle, Gift, Shield, Headphones } from "lucide-react";
    ...
    return (
      <main className="relative min-h-screen bg-background flex items-center justify-center p-4 md:p-8 overflow-hidden">
        ...
        <div className="w-full max-w-[520px] bg-white rounded-[2rem] shadow-2xl shadow-primary/5 border border-white p-8 md:p-10 flex flex-col items-center text-center gap-6">
          ...
          <Link
            href="/verify"
            className="inline-flex items-center gap-2 bg-primary text-white py-3 px-8 rounded-2xl font-bold hover:brightness-110 transition-all shadow-lg shadow-primary/20"
          >
      ...
      <div className="max-w-[1280px] w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        ...
        <div className="hidden lg:flex flex-col gap-8 pr-8 pt-4">
          ...
          <div>
            <h1 className="text-4xl font-bold text-on-background leading-tight mb-3">
              Gabung sekarang,{" "}
              <span className="text-primary">nikmati kemudahannya.</span>
            </h1>
            <p className="text-on-surface-variant">
              Ribuan pelanggan sudah mempercayakan laundry mereka kepada FreshPress.
            ...
            {[
              {
                icon: Gift,
                title: "Gratis Pickup",
                desc: "Antar-jemput tanpa biaya tambahan",
                color: "bg-emerald-50 border-emerald-100 text-emerald-600",
              },
              {
                icon: CheckCircle,
                title: "Garansi Bersih",
                desc: "Tidak puas? Uang kembali penuh",
                color: "bg-blue-50 border-blue-100 text-blue-600",
              },
              {
                icon: Shield,
                title: "Aman & Terpercaya",
                desc: "Data dan pakaian Anda terlindungi",
          ...
          <div className="bg-primary/5 border border-primary/15 rounded-2xl p-5">
            ...
            <p className="text-on-surface-variant text-sm italic">
              &ldquo;Pakaian selalu bersih dan harum, pickup tepat waktu. Sudah 6 bulan
              pakai FreshPress dan tidak mau pindah ke laundry lain!&rdquo;
            </p>
        ...
        <div className="w-full max-w-[480px] mx-auto">
          ...
          <div className="lg:hidden flex flex-col items-center mb-6">
            <div className="bg-primary p-2.5 rounded-xl shadow-lg shadow-primary/30 mb-2">
              <Shirt className="text-white w-7 h-7" />
            </div>
          ...
          <div className="bg-white border border-outline-variant rounded-2xl p-6 md:p-8 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* Nama Lengkap */}
              <div className="group">
                <label htmlFor="name" className="text-sm font-bold text-on-surface/80 ml-1 mb-1.5 block">
                  Nama Lengkap
                </label>
                ...
                {errors.name && <p className="mt-1 ml-1 text-xs text-error" role="alert">{errors.name}</p>}
              </div>

              {/* Email */}
              <div className="group">
                <label htmlFor="email" className="text-sm font-bold text-on-surface/80 ml-1 mb-1.5 block">
                  Email
                </label>
                <div className="relative flex items-center">
                ...
                {errors.email && <p className="mt-1 ml-1 text-xs text-error" role="alert">{errors.email}</p>}
              </div>

              {/* Telepon */}
              <div className="group">
                <label htmlFor="phone" className="text-sm font-bold text-on-surface/80 ml-1 mb-1.5 block">
                  Telepon{" "}
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-white px-4 text-on-surface-variant uppercase tracking-wider">Atau</span>
              </div>
            </div>
            ...
            <button
              ...
              suppressHydrationWarning
              className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-outline-variant rounded-xl bg-white hover:bg-surface-container-low transition-colors active:scale-[0.99]"
            >
