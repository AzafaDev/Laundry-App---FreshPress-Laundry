...
import { z } from "zod";
import { useForgotPassword } from "@/hooks/useEmployeeAuth";
...
export default function EmployeeForgotPasswordPage() {
  ...
  const onSubmit = (data: ForgotFormData) => mutate(data.email);
      ...
      <AuthCard>
        ...
        {isSuccess ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            {isError && <AuthErrorAlert message="Terjadi kesalahan jaringan. Silakan coba lagi." />}
